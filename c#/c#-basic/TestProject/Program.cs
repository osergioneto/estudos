...
foreach (string name in studentNames)
{
    ...
    */
    ...
    // Console.WriteLine($"sumExtraCredit: {sumExtraCredit}");

    currentStudentGrade = (decimal)(sumAssignmentScores) / examAssignments;
    overallStudentGrade = (decimal)(sumAssignmentScores + sumExtraCredit) / examAssignments;
    averageExtraCredits = (decimal)sumExtraCredit / examAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{currentStudentGrade}\t\t{overallStudentGrade}\t{currentStudentLetterGrade}\t{(int)currentStudentGrade} ({averageExtraCredits} pts)");
}
